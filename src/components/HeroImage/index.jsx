...
function HeroImage () {
    return (
        <section className="relative w-full h-[600px] bg-cover bg-center rounded-md" style={{ backgroundImage: `url(${imghero})` }} >
            <div className="absolute -bottom-8 md:-bottom-12 left-1/2 md:left-[40%] lg:left-[30%] xl:left-[25%] transform -translate-x-1/2 bg-white border rounded-md px-4 py-6 text-[#181A2A] shadow-lg 
